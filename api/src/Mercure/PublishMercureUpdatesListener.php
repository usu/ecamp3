...
/*
 * This file was originally copied from api-platform/core, but modified to implement our own mercure update logic.
 *
 * For original author and license information see upstream file.
 *
 * Upstream file (main branch):               https://github.com/api-platform/core/blob/main/src/Symfony/Doctrine/EventListener/PublishMercureUpdatesListener.php
 * Upstream file (last synchronized version): https://github.com/api-platform/core/blob/23840f9df42895d334d0db1027e3894ce411cf98/src/Symfony/Doctrine/EventListener/PublishMercureUpdatesListener.php
 * Last synchronized commit:                  2026-02-18 / 23840f9df42895d334d0db1027e3894ce411cf98
 */
...
final class PublishMercureUpdatesListener {
    ...
    private function storeObjectToPublish(object $object, string $property): void {
        ...
        // trigger publish for all operations with mercure: true
        foreach ($resourceMetadataCollection as $resourceMetadata) {
            foreach ($resourceMetadata->getOperations() ?? [] as $operation) {
                $options = $operation->getMercure();
                if ($options) {
                    $this->storeObjectToPublishForOperation($object, $property, $operation);
                }
            }
        }
    }

    private function storeObjectToPublishForOperation(object $object, string $property, HttpOperation $operation): void {
     ...
     */
    private function buildUpdate(array|string $iri, string $data, array $options): Update {
