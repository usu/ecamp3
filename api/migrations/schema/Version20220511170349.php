 ...
 */
final class Version20220511170349 extends AbstractMigration {
    ...
    public function up(Schema $schema): void {
        ...
        $this->addSql('ALTER TABLE content_node DROP strategy');
    ...
    public function down(Schema $schema): void {
        ...
        $this->addSql('ALTER TABLE content_node DROP CONSTRAINT fk_481d0580b7939b21');
        $this->addSql('ALTER TABLE content_node ADD strategy VARCHAR(255) NOT NULL');
